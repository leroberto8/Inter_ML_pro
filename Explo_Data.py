...
sns.countplot(x='weather', hue='Y', data=data, palette='Set1')  # Use 'Set1' palette  
...
plt.figure(figsize=(10, 6))  
sns.countplot(x='passanger', hue='Y', data=data, palette='Set2')  # Use 'Set2' palette  
...
plt.figure(figsize=(10, 6))  
sns.countplot(x='time', hue='Y', data=data, palette='Set3')  # Use 'Set3' palette  
...
plt.figure(figsize=(10, 6))  
sns.countplot(x='age', hue='Y', data=data, palette='pastel')  # Use 'pastel' palette  
...
plt.figure(figsize=(10, 6))  
sns.barplot(x='time', hue='Y', data=data, estimator=lambda x: sum(x == 'Yes') / len(x), palette='viridis')  # Use 'viridis' palette  
